...
qqunif <- function(x, main="QQ plot against uniform"){
...
The figure shows a quantile-quantile plot of the distribution of cosines between pairs of random unit vectors against a unform distribution on $[-1, 1].$ If the cosines were distributed uniformly, the plot would be a line of unit slope through the origin, as shown in green. The actual quantiles, shown in black, deviate from the line very little. Also shown is the result of a Kolmogorov-Smirnov test with a uniform distribution as its null hypothesis. As can be seen from the p-value, the cosines are consistent with a uniform distribution. 
