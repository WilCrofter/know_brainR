...
The assigned properties will generally be ranges. Bone density, for example, may vary considerably. In other cases assigned values will be no more than guesses. When possible, values will be taken from data [provided online](http://www.kayelaby.npl.co.uk/general_physics/2_4/2_4_6.html) by the National Physical Laboratories of the UK. These are also provided in csv form [in the current repository](../data/npl_acoustic_data.csv).
