...
### Discrete estimation of spatial resolution
...
Checkerboard patterns, though biologically unrealistic as patterns of depolarization, may be useful for studying spatial resolution. The size of a visually discernible cell either at the scalp or an inferred image at the cerebral cortex should help inform intuition.
...
Most experiments using voltage sensitive dyes, monitor a fixed band of wavelengths. (See Leslie M. Lowe [Design and Use of Organic Voltage Sensitive Dyes](http://scholar.google.com/scholar?q=Design+and+Use+of+Organic+Voltage+Sensitive+Dyes&btnG=Submit&hl=en&as_sdt=0%2C21).) Putative polarized and unpolarized spectra of dyes which emit in near infrared are shown below. Suppose these spectra were realistic and that wavelengths exceeding 900 nm were to constitute the monitored band. The ratio of polarized to unpolarized emission rates would then be 1.32.
