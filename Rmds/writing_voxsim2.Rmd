...
#### Critique based on initial coding attempts.
...
```
    + In other words, rather than supplying a pair of tables, data prep should supply a pair of custom functions which take tissue id's as arguments and return appropriate stats.
