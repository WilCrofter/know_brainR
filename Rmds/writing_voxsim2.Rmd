...
These are development notes for a second voxel-level simulator--preconceptions, problems, architecture. It is meant primarily as a reference for developers. It is not likely to be of general interest.
...
The simulator would thus expect an environment containing an initial state array, the number of iterations already performed (perhaps 0,) tables of absorption and flow statistics, and an array of functions to be executed between steps.
