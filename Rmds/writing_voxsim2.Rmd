...
Coding began with data prep. Data, of course, is required before simulation code can be tested.

1. Prepare state array
    a. Coding suggests that 1.a, and 1.b are best combined in a single function which returns a completely initialized phantom as a raw byte volume.
    b. Incorporating the raw byte volume into a state array should be a piece of standard code, as should extracting unique tissue types.
    c. Custom initializations can remain with a default of NULL.
