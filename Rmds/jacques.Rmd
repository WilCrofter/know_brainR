...
The following plots give an idea of the variability in measurements of the reduced scattering coefficient. Broken lines indicate two sample standard deviations as computed from data. 
...
Given values for these 7 parameters, the 
