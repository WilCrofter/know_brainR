...
Again, the system behaves with approximate linearity, hence the five compartments could be lumped into one. Consider the following excitation stimuli which were randomly generated with controlled correlation and temporal smoothness using convenient heuristics.
...
As the following plots show, the mean response is again very close to the response of a single compartment to the mean stimulus. 
